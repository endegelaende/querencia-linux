# Querencia Linux fork of qadwaitadecorations
# Branch: f43-el10
# Change: Enable Qt5 build on RHEL >= 10 (upstream disables it)
# Original: %bcond qt5 %[%{undefined rhel} || 0%{?rhel} < 10]
# Patched:  Always enable qt5 via bcond_without
%bcond_without qt5
...
%changelog
* Fri Mar 13 2026 Querencia Linux <querencia@endegelaende.github.io> - 0.1.7-2.querencia1
- Fork for EL10: enable Qt5 subpackage (upstream disables Qt5 on RHEL >= 10)
- Changed: %%bcond qt5 conditional replaced with %%bcond_without qt5
